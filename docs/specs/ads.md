...
2. One interstitial per round maximum.
3. Consent is asked before the first round and editable in Settings. Refusing gives non personalised ads, not fewer slots.
4. The Remove ads purchase hides every slot including the interstitial.
5. Placeholders use the ink hatch pattern so they read as part of the game, not as broken images.
